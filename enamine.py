...
train_file = '/content/drive/MyDrive/drug_discovery_data/crosstalk_train.parquet'
test_file = '/content/drive/MyDrive/drug_discovery_data/crosstalk_test.parquet'
test_file_new = '/content/drive/MyDrive/drug_discovery_data/crosstalk_test_inputs.parquet'

!unzip '/content/drive/MyDrive/drug_discovery_data/Enamine_screening_collection_sdf_202508.zip' -d '/content/drive/MyDrive/drug_discovery_data/Enamine_screening_collection_sdf_202508'

# using smart sampled data ID's
train_IDs = pd.read_csv('/content/drive/MyDrive/drug_discovery_data/training_del_ids.csv')
val_IDs = pd.read_csv('/content/drive/MyDrive/drug_discovery_data/validation_del_ids.csv')
train_sel = train_IDs['ID'].to_list()

"""## Analyse the SDF file and convert to parquet file to keep the flow

"""

# SDF File Analyzer for Drug Discovery
# ====================================

# This script analyzes SDF files containing molecular structures and extracts:
# - Molecular properties (MW, LogP, PSA, etc.)
# - Molecular fingerprints (ECFP4, ECFP6, FCFP4, FCFP6, MACCS, RDK, AVALON, ATOMPAIR, TOPTOR)
# - Basic statistics and visualizations
# - Data export for integration with existing ML workflows
...
sdf_file_path = '/content/drive/MyDrive/drug_discovery_data/Enamine_screening_collection_202508.sdf'
input = Path(sdf_file_path)
output_file_path = '/content/drive/MyDrive/drug_discovery_data/sdf_analysis_results'
...
def get_predictions(ensemble_model, X):
  ...
  for estimator in ensemble_model.estimators_:
      pred_proba = estimator.predict_proba(X)[:, 1]  # Probability of positive class
      predict = estimator.predict(X)
      predictions.append(predict)
      prob_predictions.append(pred_proba)
  ...
  Y_prob = ensemble_model.predict_proba(X)
